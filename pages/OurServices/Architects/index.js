      ...
      {/* <SmoothScroll> */}
          <div className={styles.container}>
            ...
            <div className={styles.banner1}>
                <Image src={'/servicesimages/services (8).jpg'} className={styles.bimg} width={400} height={400} alt='image' />
                <div className={styles.border}/>
                <div className={styles.over}>
                  {/* <div className={styles.btext}></div> */}
                  <div className={styles.btext2}>Our Services - Architects</div>
            ...
            <div className={styles.bottomcont}>
              ...
              <div className={styles.btmflex}>
                ...
                <div>
                  <Image src={'/servicesimages/services (8).jpg'} className={styles.img10} width={400} height={400} alt='image' />
                </div>
                <div>
